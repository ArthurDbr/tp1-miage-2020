...
Il existe 3 grands principes l'architecture hexagonale :
* Séparer l'Application, le Domaine et l'Infrastructure
* Séparer les entrés des sorties (In/Out)
* Le Domaine ne dépend de rien mais tous le reste dépend du Domaine
